...
namespace ETradeStudy.Percistance.Migrations
{
    ...
    partial class ETradeStudyContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETradeStudy.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETradeStudy.Domain.Entities.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETradeStudy.Domain.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    b.HasOne("ETradeStudy.Domain.Entities.Endpoint", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ETradeStudy.Domain.Entities.Endpoint", b =>
                {
                    b.HasOne("ETradeStudy.Domain.Entities.Menu", "Menu")
                        .WithMany("Endpoints")
            ...
            modelBuilder.Entity("ETradeStudy.Domain.Entities.Product", b =>
                {
                    b.HasOne("ETradeStudy.Domain.Entities.Category", "Category")
                        .WithMany("Products")
